...
type CurrencyRate struct {
	...
	Rate          float64                `protobuf:"fixed64,2,opt,name=rate,proto3" json:"rate,omitempty"` // курс в рублях (double = float64)
...
func (x *AddCurrencyRequest) GetRate() float64 {
	if x != nil {
		return x.Rate
	}
	return 0
...
const file_crud_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"crud.proto\x12\x04crud\"6\n" +
	"\fCurrencyRate\x12\x12\n" +
	"\x04code\x18\x01 \x01(\tR\x04code\x12\x12\n" +
	"\x04rate\x18\x02 \x01(\x01R\x04rate\"M\n" +
